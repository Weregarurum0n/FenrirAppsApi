...
If Object_ID('dbo.p_States_Get','P') Is Null
    Exec('Create Procedure dbo.p_States_Get As Select 1')
Go
/*
	Revision History:
		2/27/2019	Created
	Example Query:
		...
		Exec dbo.p_States_Get @UserID = 1, @RetVal = @RetVal out, @RetMsg = @RetMsg out
		Select @RetVal, @RetMsg
*/

Alter Procedure dbo.p_States_Get
(
	@UserID Int,
...
Select l.CountryID, 1.StateID, l.Name, l.Abbrev, l.Disabled,
...
From dbo.t_States As l With (NoLock)
