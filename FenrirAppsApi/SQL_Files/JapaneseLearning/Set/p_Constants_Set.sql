...
Begin
	...
	(ParentID, Name, Description, Disabled, CreatedID, CreatedDateTime, ModifiedID, ModifiedDateTime)
	Values
	(@ParentID, @Name, @Description, 0, @UserID, @dUtcNow, @UserID, @dUtcNow)

	If (@@RowCount = 0)
	Begin
		Select @RetVal = 41, @RetMsg = 'Unable to Insert new Entry'
	End
	Else
	Begin
...
Begin
	...
	If (@@RowCount = 0)
	Begin
		Select @RetVal = 51, @RetMsg = 'Unable to Update Entry'
	End
	Else
	Begin
