...
If Object_ID('dbo.p_Kanji_Get','P') Is Null
    Exec('Create Procedure dbo.p_Kanji_Get As Select 1')
Go
/*
	Revision History:
		Date		Editor					Comment
	...
	Example Query:
		...
		Exec dbo.p_Kanji_Get @UserID = 1, @RetVal = @RetVal out, @RetMsg = @RetMsg out
		Select @RetVal, @RetMsg
*/

Alter Procedure dbo.p_Kanji_Get
(
	@UserID Int,
...
Select k.KanjiID, k.Character, k.Romaji, k.Level, k.Example1, k.Example2, k.Example3, k.Sound,
...
From dbo.t_Kanji As k With (NoLock)
