...
namespace FenrirAppsApi.Controllers.HotelManagement
{
    ...
    public class LocationsController : Controller
    {
        ...
        [HttpGet("Country")]
        public ResponseStatus SetCountry([FromBody] SetCountry req) => _service.SetCountry(req);
        ...
        public ResponseStatus SetState([FromBody] SetState req) => _service.SetState(req);
        ...
        [HttpPost]
        public ResponseStatus SetCity([FromBody] SetCity req) => _service.SetCity(req);
    }
}